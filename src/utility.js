...
/**
 * Provides utility methods for parsing domains and Cloudflare errors.
 */
export default class Utility {
    constructor() {
        this.topLevelDomains = {
            ...
            'elasticbeanstalk.cn-north-1.amazonaws.com.cn': true,
    ...
    getDomain(url) {
        ...
        // Determines if the domain extension is a global sub-domain like 'co.uk'
        if (count > 1) {
    ...
    setStatusMessage(element, message, timeout, customHtml) {
        ...
        element.addEventListener('click', (e) => {
            if (customHtml && customHtml.length > 0) {
                ...
                e.target.innerHtml += `<div id='errorLog'><br/>${customHtml}</div>`;
            }
        });
